...
describe('deepClone', () => {
  ...
  it('should return primitive values as is', () => {
    ...
    expect(deepClone('es-toolkit')).toBe('es-toolkit');
  ...
  it('should clone ArrayBuffer objects', () => {
    ...
    const clonedArrayBuffer = deepClone(arrayBuffer);
  ...
  it('should clone TypedArray objects', () => {
    ...
    expect(typedArray).toEqual(
      new Uint8Array([255, 1, 2, 3, 4, 5, 6, 7, 8, 9]),
    );
  ...
  it('should clone custom Error', () => {
    ...
    const clonedFetcherError = deepClone(fetcherError);
    ...
    expect(clonedFetcherError.innerError.message).toBe(
      fetcherError.innerError.message,
    );
  });
  ...
  it('should clone Boolean objects', () => {
    ...
    const cloned = deepClone(boolObj);
